...
num = 30
found = 0
url = "http://192.168.137.233:8080/shot.jpg"
while found < num:  # Here, 10 can be changed to whatever number you like to choose
    ...
    if ret == True:
        ...
        filename = "C:\\Users\\Ammar Issa\\Desktop\\Camera\\" + str(found) + ".jpg"
...
fs = cv2.FileStorage("C:\\Users\\Ammar Issa\\Desktop\\Camera\\calibration.yml", cv2.FILE_STORAGE_WRITE)
...
with open("C:\\Users\\Ammar Issa\\Desktop\\Camera\\calibration.yml", "w") as f:
    yaml.dump(data, f)
