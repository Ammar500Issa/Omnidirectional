...
//  else
//    strncat(a, &'+', 1);
//  strncat(a, &char(int(v/10000)%10+48), 1);
//  strncat(a, &char(int(v/1000)%10+48), 1);
//  strncat(a, &char(int(v/100)%10+48), 1);
//  strncat(a, &'.', 1);
//  strncat(a, &char(int(v/10)%10+48), 1);
//  strncat(a, &char(int(v/1)%10+48), 1);
//  return a;
//}
...
void loop()
{
  ...
  if(currentMicros - previousMicros >= T*1000000) {
...
//    Y = YC;
    ...
    u[2] += uTheta;
    u[3] += uTheta;
//    S1.setAcceleration(u[0]*100/PI);
//    S2.setAcceleration(u[1]*100/PI);
//    S3.setAcceleration(u[2]*100/PI);
//    S4.setAcceleration(u[3]*100/PI);
    double f[4];
    f[0] = u[0]*T + lastFreq1;
    f[1] = u[1]*T + lastFreq2;
    f[2] = u[2]*T + lastFreq3;
